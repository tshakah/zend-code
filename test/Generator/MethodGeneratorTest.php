...
PHP;
    ...
    public function returnTypeHintClasses()
    {
        $parameters = [
            ...
            [ReturnTypeHintedClass::class, 'selfReturn', 'self'],
            [ReturnTypeHintedClass::class, 'parentReturn', 'parent'],
            ...
            [NullableReturnTypeHintedClass::class, 'selfReturn', '?self'],
            [NullableReturnTypeHintedClass::class, 'parentReturn', '?parent'],
